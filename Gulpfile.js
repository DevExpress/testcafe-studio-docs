...
gulp.task('generate-docs-readme', function () {
    ...
    var toc    = yaml.safeLoad(fs.readFileSync('nav/nav-menu.yml', 'utf8'));
...
gulp.task('lint-docs', function () {
    ...
    var lintDocsAndExamples = globby([
        'articles/**/*.md',
        '!articles/documentation/recipes/**/*.md',
        'examples/**/*.md'
    ]).then(function (files) {
...
gulp.task('put-in-articles', ['clean-website'], function () {
    return gulp
        .src(['articles/**/*', '!articles/blog/**/*'])
        .pipe(gulp.dest('site/src'));
});

gulp.task('put-in-posts', ['clean-website'], function () {
    return gulp
        .src('articles/blog/**/*')
...
gulp.task('prepare-website', ['put-in-assets', 'put-in-articles', 'put-in-navigation', 'put-in-posts', 'lint-docs']);
...
function testWebsite (isTravis) {
    return new Promise(function (resolve) {
        ...
        .then(function () {
            var WebsiteTester = require('./test/test.js');
